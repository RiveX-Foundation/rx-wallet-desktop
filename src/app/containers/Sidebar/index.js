...
@inject((stores) => ({
  ...
  setselectedwallettype: (wallettype) =>
    stores.walletStore.setselectedwallettype(wallettype),
...
class Sidebar extends Component {
      ...
      if (item.children) {
        return (
          <SubMenu
            ...
            title={
              <span>
                <img src={item.iconpath} width="20px" />
  ...
  selectwallettype = (e) => {
    ...
    this.setState(
      { selectedwallettype: wallettype, selectedtab: "wallet" },
      function () {
  ...
  selectimportwallettype = () => {
    var that = this;
    this.setState(
      { selectedwallettype: "importwallet", selectedtab: "wallet" },
      function () {
        that.props.clearSelectedWallet();
  ...
  selecthwwallettype = () => {
    var that = this;
    this.setState(
      { selectedwallettype: "hwwallet", selectedtab: "wallet" },
      function () {
        that.props.clearSelectedWallet();
  ...
  render() {
    ...
    const basicwalletstyle =
      selectedtab == "wallet" && selectedwallettype == "basicwallet"
        ? "ant-menu-item fontcolor_red ant-menu-item-selected"
        : "ant-menu-item fontcolor_red";
    const sharedwalletstyle =
      selectedtab == "wallet" && selectedwallettype == "sharedwallet"
        ? "ant-menu-item fontcolor_orange ant-menu-item-selected"
        : "ant-menu-item fontcolor_orange";
    const hardwarewalletstyle =
      selectedtab == "wallet" && selectedwallettype == "hwwallet"
        ? "ant-menu-item fontcolor_green ant-menu-item-selected"
        : "ant-menu-item fontcolor_green";
    const importwalletstyle =
      selectedtab == "wallet" && selectedwallettype == "importwallet"
        ? "ant-menu-item fontcolor_purple ant-menu-item-selected"
        : "ant-menu-item fontcolor_purple";
    const dexstyle =
      selectedtab == "dex"
    ...
    return (
      <div className="sidebar fadeInAnim">
        ...
        <div>
          <ul
            className="ant-menu menuTreeNode ant-menu-dark ant-menu-root ant-menu-inline"
            role="menu"
          >
            <li
            ...
            >
              ...
              >
                <span>
                  <img src={buttonwallet} width="20px" />
                  <span className="sidebar_fontsize">
                    {intl.get("menuConfig.wallet")}
                  </span>
                </span>
              </div>
              <ul
              ...
              >
                <li
                  className={basicwalletstyle}
                  data-tabvalue="wallet"
                  data-wallettype="basicwallet"
                  onClick={this.selectwallettype}
                  role="menuitem"
                >
                  <img src={buttonbasicwallet} width="25px" />
                  {intl.get("menuConfig.basicwallet")}
                </li>
                ...
                <li
                  className={importwalletstyle}
                  data-tabvalue="wallet"
                  data-wallettype="importwallet"
                  onClick={this.selectimportwallettype}
                  role="menuitem"
                >
                  <img src={buttonimportwallet} width="25px" />
                  {intl.get("menuConfig.importwallet")}
                </li>
              </ul>
            </li>
            <li
            ...
            >
              ...
              >
                <span>
                  <img src={buttonwrdex} width="20px" />
            ...
            >
              ...
              >
                <span>
                  <img src={buttonsettings} width="20px" />
                  <span className="sidebar_fontsize">
            ...
            >
              ...
              >
                <span>
                  <img src={buttonnotification} width="20px" />
                  <span>{intl.get("Notification.Notification")}</span>
                </span>
              </div>
            </li>
          </ul>
          ...
          <div className="logoutpanel" onClick={this.logout}>
            <span>
              <img src={buttonlogout} width="20px" />
              <span>{intl.get("Common.logout")}</span>
            </span>
          </div>
        </div>
      </div>
