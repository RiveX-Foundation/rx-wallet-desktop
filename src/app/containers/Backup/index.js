                        ...
                        <p className="textP">{intl.get('Backup.warning')}: {intl.get('Backup.doNotShare')}</p>
                        {
                            this.state.showMnemonic ? (
                                <div>
                                    ...
                                    {/* </Card> */}
                                    <p className="copyBtn"
                                       onClick={() => this.copy2Clipboard(this.state.mnemonic)}>[ {intl.get('Backup.copyToClipboard')} ]</p>
                                </div>
                            ) : (
                                <div>
                                    <Input.Password placeholder={intl.get('Backup.enterPassword')}
                                                    onChange={this.inputChanged} onPressEnter={this.handleOk}/>
                                </div>
                            )
                        }
                    </Modal>
