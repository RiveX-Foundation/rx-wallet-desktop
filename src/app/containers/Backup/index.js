    ...
    return (
      <div>
        <Card title={intl.get("Backup.revealSeedPhrase")}>
          <p className="com-gray">{intl.get("Backup.saveSeedPhraseNotice")}</p>
          <Button type="primary" onClick={this.showModal}>
            {intl.get("Backup.continue")}
          </Button>
          <Modal
            destroyOnClose={true}
          ...
          >
            <p className="textP">
              {intl.get("Backup.warning")}: {intl.get("Backup.doNotShare")}
            </p>
            {this.state.showMnemonic ? (
              <div>
                ...
                <p
                  className="copyBtn"
                  onClick={() => this.copy2Clipboard(this.state.mnemonic)}
                >
              ...
              <div>
                <Input.Password
                  placeholder={intl.get("Backup.enterPassword")}
