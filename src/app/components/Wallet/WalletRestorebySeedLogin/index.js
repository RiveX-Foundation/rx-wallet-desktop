    ...
    render() {
        return (
            <div className="walletkeyinseedpanel fadeInAnim">
                <div className="title"><span><img onClick={this.backToLogin} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Wallet.RESTOREMNEMONICPHRASE')}</span></div>
                <div className="centerpanel">
                    <center>
                        <div className="inputwrapper">
                            ...
                            <div className="panelwrapper borderradiusfull" style={{width: "150px"}}>
                                <Input id="password" type="password" className="inputTransparent"
