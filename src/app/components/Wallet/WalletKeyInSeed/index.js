        ...
        return (
            <div className="walletkeyinseedpanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Wallet.VerifyRecoveryPhrase')}</span></div>
                <div className="centerpanel">
                    ...
                    <div className="buttonpanel"><Button className="curvebutton" style={nextbuttonstyle}
                                                         onClick={this.next}>{intl.get('Wallet.Confirm')}</Button></div>

                    <div className="originalseedpanel"
                         style={{height: "200px", width: "600px", display: "inline-block", marginTop: "30px"}}>
                        {
