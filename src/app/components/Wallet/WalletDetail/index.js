        ...
        {this.props.selectedWallet.walletname != null &&
          <div>
            ...
            <div className="contentpanel">
              ...
              <Button className="butreceive button" onClick={this.receiveToken} style={{marginRight:"10px"}}><span><img src={buttonreceive} /></span><span style={{marginLeft:"10px"}}>{intl.get('Token.Receive')}</span></Button>
