        ...
        return (
            <div className="tokentransferpanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('TokenTransfer.SendToken')}</span></div>
                <div className="centerpanel">
                    <center>
                        <div className="subtitle">{intl.get("TokenTransfer.ReceipientAddress")}</div>
                        <div className="panelwrapper borderradiusfull" style={{marginBottom: "10px"}}><Input
                            className="inputTransparent" ref={(input) => {
                            this.inputEl1 = input;
