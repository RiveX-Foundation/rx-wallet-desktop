...
import cloudicon from 'static/image/icon/cloud.png';
    ...
    return (
      <div className="wallettypeselectionpanel fadeInAnim">
        ...
        <div className="centerpanel">
          <center>
            <div className="panelwrapper borderradiusfull spacebetween" onClick={() => this.setBasicWalletType('local')} style={{marginBottom:"10px"}}>
