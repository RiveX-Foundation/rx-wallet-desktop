        ...
        return (
            <div className="walletcreationpanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Wallet.RecoveryPhrase')}</span></div>
                <div className="centerpanel">
                    <center>
                        <div style={{width: "600px"}}>
                            <div className="hint">{intl.get('Wallet.WriteDownRecoveryPhrase')}</div>
                            <ul>{this.state.seedphaseel}</ul>
                            <div><Button className="copybutton"
                                         onClick={this.copy}>{intl.get('Backup.copyToClipboard')}</Button></div>
                            <div className="hint2" style={{
                                marginTop: "40px",
                                marginBottom: "30px"
                            }}>{intl.get('Wallet.NeverShareRecovery')}</div>
                            ...
                            <input onChange={this.onChange} style={{marginTop: -99999, position: "absolute"}}
                                   ref={(input) => {
                                       this.inputEl1 = input;
                                   }} type="text" value={this.state.mnemonic} id="hiddenphase"/>
                        </div>
                    </center>
                </div>
                <Modal
