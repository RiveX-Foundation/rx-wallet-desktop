...
class WalletListing extends Component {
  ...
  selectWallet = (e) => {
    var walletpublicaddress = e.currentTarget.getAttribute(
      "data-publicaddress"
    );
    this.setState({
  ...
  render() {
    return (
      <div className="walllistingpanel fadeInAnim">
        <div className="plussign" onClick={this.createWallet}>
          <img src={buttonplussign} />
        </div>
        <ul style={{ position: "relative" }}>
          ...
          <div
            ...
            style={{
              ...
              top: `${this.state.baroffsettop}px`,
            }}
          ></div>
        </ul>
      </div>
