        ...
        return (
            <div className="wallettypeselectionpanel fadeInAnim">
                ...
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Wallet.SHAREDWALLET')}</span></div>
                <div className="centerpanel">
                    <center>
                        <div className="panelwrapper borderradiusfull spacebetween" onClick={this.sharedwallet}
                             style={{marginBottom: "10px"}}>
                            <div className="panelleft"><img
                                src={buttoncreatesharedwallet}/><span>{intl.get('Wallet.CreateSharedWallet')}</span>
                            </div>
                            <div className="panelright"><img src={buttonnext}/></div>
                        </div>
                        <div className="panelwrapper borderradiusfull spacebetween" onClick={this.joinwallet}
                             style={{marginBottom: "10px"}}>
                            <div className="panelleft"><img
                                src={buttonjoinsharedwallet}/><span>{intl.get('Wallet.JoinSharedWallet')}</span></div>
                            <div className="panelright"><img src={buttonnext}/></div>
                        </div>
                    </center>
                </div>
