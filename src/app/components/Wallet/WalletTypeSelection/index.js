...
@inject((stores) => ({
  ...
  setSeedPhaseInString: (seedphase) =>
    stores.walletStore.setSeedPhaseInString(seedphase),
  setCurrent: (current) => stores.walletStore.setCurrent(current),
  setTotalSignatures: (totalsignatures) =>
    stores.walletStore.setTotalSignatures(totalsignatures),
  setTotalOwners: (totalowners) =>
    stores.walletStore.setTotalOwners(totalowners),
        ...
        <div className="centerpanel">
          <center>
            <div
              ...
              onClick={this.sharedwallet}
              style={{ marginBottom: "10px" }}
            >
              <div className="panelleft">
                <img src={buttoncreatesharedwallet} />
                <span>{intl.get("Wallet.CreateSharedWallet")}</span>
              </div>
            ...
            <div
              className="panelwrapper borderradiusfull spacebetween"
              onClick={this.joinwallet}
              style={{ marginBottom: "10px" }}
            >
              <div className="panelleft">
                <img src={buttonjoinsharedwallet} />
                <span>{intl.get("Wallet.JoinSharedWallet")}</span>
              </div>
              <div className="panelright">
                <img src={buttonnext} />
              </div>
