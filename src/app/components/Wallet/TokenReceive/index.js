        ...
        return (
            <div className="tokenreceivepanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Token.ReceiveToken')}</span></div>
                <div className="centerpanel">
                    <center>
                        <div className="inputwrapper">
                            <div style={{marginBottom: "10px"}}
                                 className="subtitle">{this.props.selectedWallet.walletname}</div>
                            <center>
                            ...
                            <input onChange={this.onChange} style={{marginTop: -99999, position: "absolute"}}
                                   ref={(input) => {
                                       this.inputEl1 = input;
                                   }} type="text" value={publicaddr} id="hiddenphase"/>
                        </div>
                    </center>
                </div>
            </div>
