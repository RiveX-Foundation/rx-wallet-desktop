        ...
        <div className="centerpanel">
          <center>
            <div className="plaintext" style={{ marginBottom: "15px" }}>
              <b className="secretkey">{intl.get("Twofa.Disable")}</b>
            </div>
            <div style={{ marginBottom: "30px" }}>
              <img src={buttonartboard3} width="350px" />
            </div>
            <div className="plaintext" style={{ marginBottom: "10px" }}>
              {intl.get("Twofa.Disablewarning1")}
              <br />
              {intl.get("Twofa.Disablewarning2")}
            </div>
            <div className="inputpanel">
              ...
              <div className="buttonpanel">
                <Button className="curvebutton" onClick={this.remove}>
                  {"Remove"}
                </Button>
              </div>
            </div>
