        ...
        return (
            <div className="createwalletpanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{intl.get('Wallet.CREATESHAREDWALLET')}</span></div>
                    ...
                    <center>
                        <div className="inputwrapper">
                            ...
                            <div className="panelwrapper borderradiusfull" style={{width: "150px", padding: '0px'}}>
                                ...
                                <InputNumber style={{height: "45px"}} min={2} max={6} defaultValue={2}
                                             className="inputTransparent" onChange={this.TotalPlayerOnChange}/>
                            </div>
                            ...
                            <div className="panelwrapper borderradiusfull" style={{width: "150px", padding: '0px'}}>
                                ...
                                <InputNumber style={{height: "45px"}} min={2} max={6} defaultValue={2}
                                             className="inputTransparent" onChange={this.TotalSignatureOnChange}/>
                            </div>

                            <Button className="curvebutton" onClick={this.next}
                                    style={{width: '200px'}}>{this.state.buttonlabel}</Button>
                        </div>
                    </center>
                </div>
            </div>
