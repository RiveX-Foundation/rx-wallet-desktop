...
class CreateShareWallet extends Component {
  ...
  setButtonLabel = () => {
    this.setState({
      buttonlabel:
        intl.get("Wallet.Create") +
        " " +
        this.state.totalsignatures +
        " / " +
        this.state.totalowners +
        " " +
      ...
      <div className="createwalletpanel fadeInAnim">
        <div className="title">
          ...
          <span style={{ marginLeft: "20px" }}>
            {intl.get("Wallet.CREATESHAREDWALLET")}
          </span>
        </div>
            ...
            <div className="inputwrapper">
              ...
              >
                ...
                <InputNumber
                  ...
                  defaultValue={2}
                  className="inputTransparent"
                  onChange={this.TotalPlayerOnChange}
                />
              </div>

              <div className="subtitle">
                {intl.get("Wallet.TotalSignatures")}
              </div>
              <div
                className="panelwrapper borderradiusfull"
                style={{ width: "150px", padding: "0px" }}
              >
                ...
                <InputNumber
                  ...
                  defaultValue={2}
                  className="inputTransparent"
                  onChange={this.TotalSignatureOnChange}
                />
              </div>
