        ...
        <div className="centerpanel">
          <center>
            <div
              ...
              onClick={this.selectseedphrase}
              style={{ marginBottom: "10px" }}
            >
              <div className="panelleft">
                <img src={mnemonicphrase} />
                <span>{intl.get("Wallet.Mnemonicphrase")}</span>
              </div>
            ...
            </div>
            {
              ...
              >
                <div className="panelleft">
                  <img src={buttonprivatekey} />
                  <span>{intl.get("Wallet.PrivateKey")}</span>
                </div>
                <div className="panelright">
                  <img src={buttonnext} />
                </div>
