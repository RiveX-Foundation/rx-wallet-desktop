        ...
        return (
            <div className="splashcreatebasicwalletpanel fadeInAnim">
                <div className="title"><span><img onClick={this.back} width="20px" src={buttonback}/></span><span
                    style={{marginLeft: "20px"}}>{'Create two factor authentication'}</span></div>
                <div className="centerpanel">
                    <center>
                        ...
                        <div className="plaintext"
                             style={{marginTop: "20px", marginBottom: "15px"}}>{intl.get('Twofa.Afterscan')}</div>
                        <div className="inputpanel">
                            ...
                            <div className="plaintext"
                                 style={{marginTop: "15px", marginBottom: "2px"}}>{intl.get('Twofa.Entercode')}</div>
                            <div className="buttonpanel"><Button className="curvebutton"
                                                                 onClick={this.warning}>{intl.get('Auth.Verify')}</Button>
                            </div>
                        </div>
                    </center>
                    <Modal
                    ...
                    >
                        ...
                        <center>
                            <div className='pmodalcontent'
                                 style={{textAlign: "center"}}>{'Are you sure you saved your secret key?'}
