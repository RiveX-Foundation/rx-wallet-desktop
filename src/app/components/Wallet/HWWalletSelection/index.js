    ...
    render() {
        return (
            <div className="wallettypeselectionpanel fadeInAnim">
                <div className="title"><span style={{marginLeft: "20px"}}>{intl.get('HWWallet.ConnectHWWallet')}</span>
                </div>
                <div className="centerpanel">
                    <center>
                        <div className="panelwrapper borderradiusfull spacebetween" onClick={this.selectledger}
                             style={{marginBottom: "10px"}}>
                            <div className="panelleft"><img
                                src={buttonledger}/><span>{intl.get('HWWallet.Ledger')}</span></div>
                            <div className="panelright"><img src={buttonnext}/></div>
                        </div>
                        <div className="panelwrapper borderradiusfull spacebetween" onClick={this.selecttrezor}
                             style={{marginBottom: "10px", display: "none"}}>
                            <div className="panelleft"><img
                                src={buttontrezor}/><span>{intl.get('HWWallet.Trezor')}</span></div>
                            <div className="panelright"><img src={buttonnext}/></div>
                        </div>
                    </center>
                </div>
