        ...
        return (
            <div className="networkpanel fadeInAnim">
                ...
                <div className="centerpanel">
                    <div className="inputwrapper">
                        <div className="panelwrapper">
                            <Input data-networktype="eth" value={this.props.selectedethnetwork.name}
                                   placeholder={intl.get('Settings.ETHNetwork')} onClick={this.showlist}
                            ...
                            <div className={ethautoliststyle}>
                                {
                                    ...
                                    <ul>
                                        {ethfilterlist.map((item, index) => <li data-networktype="eth" key={index}
                                                                                data-code={item.shortcode}
                                                                                onMouseDown={this.selectnetwork}
                                                                                style={{color: item.color}}>{item.name}</li>)}
                                    </ul>
                                }
                ...
                <div className="centerpanel">
                    <div className="inputwrapper">
                        <div className="panelwrapper">
                            <Input data-networktype="wan" value={this.props.selectedwannetwork.name}
                                   placeholder={intl.get('Settings.WANNetwork')} onClick={this.showlist}
                                   onBlur={this.hidelist} onFocus={this.showlist} className="inputTransparent"
                                   onChange={this.setfilterlist}/>
                            <div className={wanautoliststyle}>
                                {
                                    ...
                                    <ul>
                                        {wanfilterlist.map((item, index) => <li data-networktype="wan" key={index}
                                                                                data-code={item.shortcode}
                                                                                onMouseDown={this.selectnetwork}
                                                                                style={{color: item.color}}>{item.name}</li>)}
                                    </ul>
