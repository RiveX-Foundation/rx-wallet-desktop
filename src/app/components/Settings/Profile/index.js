...
@inject((stores) => ({
  ...
  wsRequestUpdateProfileTokenOTP: () =>
    stores.userRegistration.wsRequestUpdateProfileTokenOTP(),
  wsUpdateProfile: (name, email, mobile, countrycode, password, otp, loginid) =>
    stores.userRegistration.wsUpdateProfile(
      name,
      email,
      mobile,
      countrycode,
  ...
  render() {
    ...
    return (
      <div className="profilepanel fadeInAnim">
        <div className="title">
          <span>{intl.get("Settings.Profile")}</span>
        </div>
          ...
          <div className="inputpanel">
            <div className="panelwrapper borderradiusfull">
              ...
              <Input
                ...
                placeholder={intl.get("Register.Name")}
            ...
            <div className="panelwrapper borderradiusfull">
              ...
              <Input
                ...
                placeholder={intl.get("Register.LoginId")}
                className="inputTransparent"
                onChange={this.inputChanged}
              />
            </div>
            ...
            <div className="panelwrapper borderradiusleft countrycodewrapper">
              ...
              <Input
                ...
                placeholder={intl.get("Register.CountryCode")}
                  ...
                  <ul>
                    {filterlist.map((item, index) => (
                      <li
                        ...
                        onMouseDown={this.selectcountry}
                      >
            ...
            {this.props.twoFAType == "totp" && (
              <React.Fragment>
                ...
                >
                  {intl.get("Settings.Key") + " : " + this.props.googleAuthKey}
                </div>
            ...
            <div>
              <Button className="curvebutton" onClick={this.save}>
