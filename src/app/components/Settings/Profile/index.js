                ...
                <div className="centerpanel">
                    ...
                    <div className="inputpanel">
                        <div className="panelwrapper borderradiusfull">
                            ...
                            <Input id="name" value={this.state.name} placeholder={intl.get('Register.Name')}
                        ...
                        <div className="panelwrapper borderradiusfull">
                            ...
                            <Input id="email" value={this.state.email} placeholder={intl.get('Register.Email')}
                                   className="inputTransparent" onChange={this.inputChanged}/>
                        </div>
                        ...
                        <div className="panelwrapper borderradiusfull">
                            ...
                            <Input id="loginid" value={this.state.loginid} placeholder={intl.get('Register.LoginId')}
                                   className="inputTransparent" onChange={this.inputChanged}/>
                        </div>
                        ...
                        <div className="panelwrapper borderradiusleft countrycodewrapper">
                            ...
                            <Input id="countrycode" value={this.state.countrycode}
                                   placeholder={intl.get('Register.CountryCode')} onClick={this.showlist}
                                   onBlur={this.hidelist} onFocus={this.showlist} className="inputTransparent"
                                   onChange={this.setfilterlist}/>
                            <div className={autoliststyle}>
                                {filterlist.length > 0 &&
                                <ul>
                                    {filterlist.map((item, index) => <li key={index} data-code={item.dial_code}
                                                                         onMouseDown={this.selectcountry}>{item.dial_code} {item.name}</li>)}
                                </ul>
                                }
                        ...
                        <div className="panelwrapper borderradiusright phonewrapper">
                            ...
                            <Input id="mobile" value={this.state.mobile} placeholder={this.state.mobile}
                                   className="inputTransparent" onChange={this.inputChanged}/>
                        </div>

                        <div className="panelwrapper borderradiusfull">
                            <Input.Password id="password" placeholder={intl.get('Register.Password')}
                                            className="inputTransparent" onChange={this.inputChanged}/>
                        </div>

                        <div className="panelwrapper borderradiusfull">
                            <Input.Password id="confirmpassword" placeholder={intl.get('Register.ConfirmPassword')}
                                            className="inputTransparent" onChange={this.inputChanged}/>
                        </div>

                        {
                            ...
                            <div className="panelwrapper borderradiusfull spacebetween">
                                <div className="panellabel" style={{paddingLeft: "0px", marginTop: "5px"}}><Input
                                    id="otp" className="inputTransparent otpinputclass" value={this.state.otp}
                                    onChange={this.inputChanged} placeholder={intl.get('Auth.EnterOTP')}/></div>
...

                        {
                            ...
                            <div className="panelwrapper borderradiusfull">
                                <Input id="otp" type="password" className="inputTransparent" value={this.state.otp}
...

                        {
                            ...
                            <React.Fragment>
                                <div className="panellabel" style={{
                                    marginTop: "30px",
                                    paddingLeft: "0px"
                                }}>{intl.get('Settings.Key') + " : " + this.props.googleAuthKey}</div>
                                ...
                                <div style={{width: "160px"}} className="panelwrapper borderradiusfull">
                                    <Input.Password id="otp" className="inputTransparent" value={this.state.otp}
                                                    onChange={this.inputChanged}
                                                    placeholder={intl.get('Settings.2FASecurity.SecurityCode')}/>
                                </div>
                            </React.Fragment>
                        ...
                        <div><Button className="curvebutton" onClick={this.save}>{intl.get('Common.Save')}</Button>
                        </div>
