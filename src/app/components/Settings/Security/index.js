            ...
            if (authcode) {
              if (
                ...
                bcrypt.hash(this.state.password, 10, (err, hash) => {
                  createNotification(
                    "success",
                    "Changed password, all wallets are deleted. The app will relaunch in 5 seconds."
                  );
                ...
                createNotification(
                  "error",
                  "Passwords don't match or are shorter than 6 characters."
                );
                this.setState({
                  password: "",
                  currentpassword: "",
        ...
        <div className="centerpanel" style={{ marginTop: "-50px" }}>
              ...
              <div>
                {this.state.googleAuthKey == "" ||
                  (this.state.googleAuthKey == null && (
                    <React.Fragment>
                      ...
                      >
                        <span className="lock">
                          {intl.get("Settings.2FASecurity.Disabled")}
                        </span>
                      </div>
                      <img src={unlock} style={{ width: "150px" }} />
                      <Button className="curvebutton" onClick={this.start2fa}>
                        {intl.get("Settings.2FASecurity.Enable")}
                      </Button>
                      <div>
                        <div
                          className="title"
                          style={{ marginTop: "30px", paddingLeft: "0px" }}
                        >
                          <span className="lock">{"Change password"}</span>
                        </div>
                ...
                {this.state.googleAuthKey != null && (
                  <React.Fragment>
                    ...
                    >
                      <span className="lock">
                        {intl.get("Settings.2FASecurity.Enabled")}
                      </span>
                    </div>
                    <img src={lock} style={{ width: "150px" }} />
                    <Button className="curvebutton" onClick={this.disable2fa}>
                      {intl.get("Settings.2FASecurity.Disable")}
                    </Button>
          ...
          >
            <p className="modalcontent">
              {"Warning! Changing the password will delete all the wallets!"}
            </p>
            <div className="inputpanel">
              <center>
                <div
