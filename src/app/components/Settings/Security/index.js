...
import { Input, InputNumber, Tooltip, Button, Radio, Icon, Modal } from 'antd';
        ...
        <div className="centerpanel" style={{marginTop:"-50px"}}>
          <div className="inputpanel">
            <Radio.Group onChange={this.onChange} value={this.state.value}>
             ...
             <div>
             <div className="title" style={{marginTop:"30px",paddingLeft:"0px"}}><span className="lock">{"Change password"}</span></div>
                ...
                <div><Button className="curvebutton" onClick={this.changePassword} >{"Change"}</Button></div>   
                <br/>          
             </div>
              </React.Fragment>                
            }
              ...
              <React.Fragment>
                ...
                <div><Button className="curvebutton" onClick={this.changePassword} >{intl.get('Common.Save')}</Button></div>   
                <br/>          
             </div>
              </React.Fragment>                
            } 
