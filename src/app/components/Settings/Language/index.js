...
class Language extends Component {
  ...
  selectlanguage = (e) => {
    this.setState(
      { language: e.currentTarget.getAttribute("data-code") },
      () => {
  ...
  render() {
    ...
    return (
      <div className="languagepanel fadeInAnim">
        <div className="title">
          <span>{intl.get("Settings.Language")}</span>
        </div>
          ...
          <div className="inputwrapper">
            <div className="panelwrapper">
              <Input
                ...
                value={name}
                id="language"
                placeholder={intl.get("Settings.Language")}
                  ...
                  <ul>
                    {filterlist.map((item, index) => (
                      <li
                        ...
                        onMouseDown={this.selectlanguage}
                      >
                        {item.name}
                      </li>
                    ))}
