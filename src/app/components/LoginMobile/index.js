                ...
                <div className="leftpanel" onClick={this.panelClick}>
                    ...
                    <center>
                        <div className="panelwrapper borderradiusfull loginpanel">
                            <Input.Password style={{marginLeft: "4px"}} id="loginpassword"
                                            placeholder={intl.get('Register.Password')} className="inputTransparent"
                                            onChange={this.inputChanged} onKeyDown={this.onKeyDown}/>
                            <span><Button className="nextbutton" onClick={this.login}><img
                                src={buttonnext}/></Button></span>
                        </div>
                        <div className="buttonpanel" style={{marginTop: "0px"}}>
                            <Button className="curvebutton"
                                    onClick={this.restore}>{intl.get('Settings.Restore')}</Button>
                            <Button className="curvebutton" style={{marginLeft: "30px"}}
                                    onClick={this.create}>{intl.get('Settings.Create')}</Button>
                        </div>
