...
import {checkAddrType, getTypeByWalletId, getWalletIdByType} from '../utils/helper';
import {formatNum, fromWei, timeFormat, WALLETID, WANPATH} from '../utils/support';
...
class WanAddress {
    ...
    @computed get getNormalAmount() {
        ...
        Object.values({normal: self.addrInfo.normal, import: self.addrInfo.import}).forEach(value => {
