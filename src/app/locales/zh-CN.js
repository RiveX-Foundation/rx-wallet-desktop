const zh_CN = {
  ...
  "Settings.ExportPrivateKeyDesc":
    "必须了解私钥是您帐户信息中最重要的部分。占有私钥的人可以完全控制相关的资金和资产。备份您的帐户非常重要，要保持秘密, 以及永远不应该丢失它。 ",
  "Settings.ExportPrivateKey.Msg1":
    "您必须清楚了解私钥是您账户中最重要与最敏感的资讯。",
  "Settings.ExportPrivateKey.Msg2":
    "任何人知道了您的私钥将能够全面控制您钱包里的资金与资产。",
  "Settings.ExportPrivateKey.Msg3":
    "它将是还原您钱包很重要的一项，千万不能将它公开，收为己用。",
  ...
  "Twofa.Warning1":
    "请把密钥保存在纸上。此密钥可让您在手机丢失的情况下恢复您的谷歌身份验证器.",
  "Twofa.Warning2":
    "如果您丢失了双重要素身份验证密钥，则将无法登录，且该帐户将无法恢复.",
  "Twofa.Scanbarcode": "使用双重要素身份验证应用程序扫描条形码",
  "Twofa.Useapp":
    "使用您的双重要素身份验证应用程序（例如Google Authenticator）扫描以下条形码.",
  "Twofa.Cantuse":
    "如果您无法扫描条形码，请手动输入纯文本密钥。请将此密钥保存在安全的地方.",
  "Twofa.Afterscan":
    "您的应用程序将在扫描条形码后显示6位数代码. 在下面输入此代码，然后输入您的钱包密码. 点击验证以完成.",
  "Twofa.Entercode": "输入您应用程序中的6位数代码",

  "DEX.Warning1":
    "通过点击“ WRDEX”，您将被带到 www.wrdex.io，这是一个与Rivex Foundation Limited无关联的公开资源的去中心化交易所。当你访问www.wrdex.io，即表示您完全同意以下内容",
  "DEX.Warning2":
    "任何因后果性，无关紧要，间接和直接使用WRDEX而引起的损失及损害均由您完全承担.",
