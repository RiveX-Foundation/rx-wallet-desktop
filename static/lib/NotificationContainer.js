      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              NotificationContainer.__proto__ ||
              Object.getPrototypeOf(NotificationContainer)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
        ...
        (_this.UNSAFE_componentWillMount = function () {
          _NotificationManager2.default.addChangeListener(
            _this.handleStoreChange
          );
        }),
        (_this.UNSAFE_componentWillUnmount = function () {
          _NotificationManager2.default.removeChangeListener(
            _this.handleStoreChange
          );
        }),
